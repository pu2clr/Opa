 ...
 */
@Stateless
@Path("br.eti.caratti.deviceactivation")
public class ActivateDevice {
    ...
    /** Creates a new instance of ActivateDevice */
    public ActivateDevice() {
    }

    /**
     * Retrieves representation of an instance of br.eti.caratti.restful.ActivateDevice
     * @return an instance of java.lang.String
     */
    @GET
    @Produces("application/json")
    @Path("/{deviceId}/{typedCode}")
    ...
    /**
     * PUT method for updating or creating an instance of ActivateDevice
